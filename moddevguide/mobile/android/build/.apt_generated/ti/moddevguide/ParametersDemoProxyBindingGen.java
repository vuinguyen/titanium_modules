...
import ti.moddevguide.ParametersDemoProxy;


/* WARNING: this code is generated for binding methods in Android */
public class ParametersDemoProxyBindingGen
	extends ti.moddevguide.LifeCycleProxyBindingGen
{
	private static final String TAG = "ParametersDemoProxyBindingGen";

	private static final String METHOD_analyzeParameters = "analyzeParameters";
		
	public ParametersDemoProxyBindingGen() {
		super();
		// Constants are pre-bound
		
		bindings.put(METHOD_analyzeParameters, null);
	...
	public Object getBinding(String name) {
		...
		// Methods
		if (name.equals(METHOD_analyzeParameters)) {
			KrollMethod analyzeParameters_method = new KrollMethod(METHOD_analyzeParameters) {
				public Object invoke(KrollInvocation __invocation, Object[] __args) throws Exception
				{
	

	Object __analyzeParameters_tmp;
	...
	((ParametersDemoProxy) __invocation.getProxy()).analyzeParameters(
		args
		);
		return KrollProxy.UNDEFINED;
				}
			};
			bindings.put(METHOD_analyzeParameters, analyzeParameters_method);
			return analyzeParameters_method;
		}
	...
	private static final String SHORT_API_NAME = "ParametersDemo";
	private static final String FULL_API_NAME = "Moddevguide.ParametersDemo";
	private static final String ID = "ti.moddevguide.ParametersDemoProxy";
	...
	public Class<? extends KrollProxy> getProxyClass() {
		return ParametersDemoProxy.class;
	}
